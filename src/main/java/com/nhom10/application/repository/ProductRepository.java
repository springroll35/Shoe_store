package com.nhom10.application.repository;

import com.nhom10.application.entity.Product;
import com.nhom10.application.model.dto.ChartDTO;
...
//    @Query(value = "SELECT NEW dto.model.com.nhom10.application.ProductInfoDTO(p.id, p.name, p.slug, p.price ,p.images ->> '$[0]', p.total_sold) " +
//            "FROM product p " +
//            "WHERE p.status = 1 " +
